...
export interface ChemicalReaction {
  ...
  export const CHEMICAL_REACTIONS: ChemicalReaction[] = [
    ...
    { id: 31, level: 3, reactants: [{ formula: 'HNO3', coefficient: 2 }, { formula: 'Ca(OH)2', coefficient: 1 }], products: [{ formula: 'Ca(NO3)2', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: '2HNO₃ + Ca(OH)₂ → Ca(NO₃)₂ + 2H₂O' },
    { id: 32, level: 3, reactants: [{ formula: 'HCl', coefficient: 1 }, { formula: 'KOH', coefficient: 1 }], products: [{ formula: 'KCl', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'HCl + KOH → KCl + H₂O' },
    { id: 33, level: 3, reactants: [{ formula: 'H2SO4', coefficient: 1 }, { formula: 'KOH', coefficient: 2 }], products: [{ formula: 'K2SO4', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂SO₄ + 2KOH → K₂SO₄ + 2H₂O' },
    { id: 34, level: 3, reactants: [{ formula: 'HCl', coefficient: 3 }, { formula: 'Al(OH)3', coefficient: 1 }], products: [{ formula: 'AlCl3', coefficient: 1 }, { formula: 'H2O', coefficient: 3 }], equation: '3HCl + Al(OH)₃ → AlCl₃ + 3H₂O' },
    { id: 35, level: 3, reactants: [{ formula: 'H2SO4', coefficient: 1 }, { formula: 'Mg(OH)2', coefficient: 1 }], products: [{ formula: 'MgSO4', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂SO₄ + Mg(OH)₂ → MgSO₄ + 2H₂O' },
    { id: 36, level: 3, reactants: [{ formula: 'CH3COOH', coefficient: 1 }, { formula: 'KOH', coefficient: 1 }], products: [{ formula: 'CH3COOK', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'CH₃COOH + KOH → CH₃COOK + H₂O' },
    { id: 37, level: 3, reactants: [{ formula: 'CO2', coefficient: 1 }, { formula: 'Ca(OH)2', coefficient: 1 }], products: [{ formula: 'CaCO3', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'CO₂ + Ca(OH)₂ → CaCO₃ + H₂O' },
    { id: 38, level: 3, reactants: [{ formula: 'NH3', coefficient: 1 }, { formula: 'HCl', coefficient: 1 }], products: [{ formula: 'NH4Cl', coefficient: 1 }], equation: 'NH₃ + HCl → NH₄Cl' },
    { id: 39, level: 3, reactants: [{ formula: 'NH3', coefficient: 2 }, { formula: 'H2SO4', coefficient: 1 }], products: [{ formula: '(NH4)2SO4', coefficient: 1 }], equation: '2NH₃ + H₂SO₄ → (NH₄)₂SO₄' },
    { id: 40, level: 3, reactants: [{ formula: 'H2S', coefficient: 1 }, { formula: 'NaOH', coefficient: 2 }], products: [{ formula: 'Na2S', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂S + 2NaOH → Na₂S + 2H₂O' },
    { id: 41, level: 3, reactants: [{ formula: 'H2S', coefficient: 1 }, { formula: 'KOH', coefficient: 2 }], products: [{ formula: 'K2S', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂S + 2KOH → K₂S + 2H₂O' },
    { id: 42, level: 3, reactants: [{ formula: 'H2S', coefficient: 1 }, { formula: 'Ca(OH)2', coefficient: 1 }], products: [{ formula: 'CaS', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂S + Ca(OH)₂ → CaS + 2H₂O' },
    { id: 43, level: 3, reactants: [{ formula: 'H2S', coefficient: 1 }, { formula: 'Ba(OH)2', coefficient: 1 }], products: [{ formula: 'BaS', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'H₂S + Ba(OH)₂ → BaS + 2H₂O' },
    { id: 44, level: 3, reactants: [{ formula: 'NH3', coefficient: 1 }, { formula: 'HNO3', coefficient: 1 }], products: [{ formula: 'NH4NO3', coefficient: 1 }], equation: 'NH₃ + HNO₃ → NH₄NO₃' },
    { id: 45, level: 3, reactants: [{ formula: 'NH3', coefficient: 1 }, { formula: 'CH3COOH', coefficient: 1 }], products: [{ formula: 'CH3COONH4', coefficient: 1 }], equation: 'NH₃ + CH₃COOH → CH₃COONH₄' },
    { id: 46, level: 3, reactants: [{ formula: 'NH3', coefficient: 1 }, { formula: 'HF', coefficient: 1 }], products: [{ formula: 'NH4F', coefficient: 1 }], equation: 'NH₃ + HF → NH₄F' },
    { id: 47, level: 3, reactants: [{ formula: 'NaOH', coefficient: 1 }, { formula: 'HF', coefficient: 1 }], products: [{ formula: 'NaF', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'NaOH + HF → NaF + H₂O' },
    { id: 48, level: 3, reactants: [{ formula: 'KOH', coefficient: 1 }, { formula: 'HF', coefficient: 1 }], products: [{ formula: 'KF', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'KOH + HF → KF + H₂O' },
    { id: 49, level: 3, reactants: [{ formula: 'Ca(OH)2', coefficient: 1 }, { formula: 'HF', coefficient: 2 }], products: [{ formula: 'CaF2', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'Ca(OH)₂ + 2HF → CaF₂ + 2H₂O' },
  
    // Level 4 - 酸化還元反応
    { id: 50, level: 4, reactants: [{ formula: 'MnO2', coefficient: 1 }, { formula: 'HCl', coefficient: 4 }], products: [{ formula: 'MnCl2', coefficient: 1 }, { formula: 'Cl2', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'MnO₂ + 4HCl → MnCl₂ + Cl₂ + 2H₂O' },
    { id: 51, level: 4, reactants: [{ formula: 'Br2', coefficient: 1 }, { formula: 'KI', coefficient: 2 }], products: [{ formula: 'KBr', coefficient: 2 }, { formula: 'I2', coefficient: 1 }], equation: 'Br₂ + 2KI → 2KBr + I₂' },
    { id: 52, level: 4, reactants: [{ formula: 'KMnO4', coefficient: 2 }, { formula: 'HCl', coefficient: 16 }], products: [{ formula: 'MnCl2', coefficient: 2 }, { formula: 'Cl2', coefficient: 5 }, { formula: 'H2O', coefficient: 8 }, { formula: 'KCl', coefficient: 2 }], equation: '2KMnO₄ + 16HCl → 2MnCl₂ + 5Cl₂ + 8H₂O + 2KCl' },
    { id: 53, level: 4, reactants: [{ formula: 'Cu', coefficient: 1 }, { formula: 'H2SO4', coefficient: 2 }], products: [{ formula: 'CuSO4', coefficient: 1 }, { formula: 'SO2', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'Cu + 2H₂SO₄ → CuSO₄ + SO₂ + 2H₂O' },
    { id: 54, level: 4, reactants: [{ formula: 'Zn', coefficient: 1 }, { formula: 'H2SO4', coefficient: 2 }], products: [{ formula: 'ZnSO4', coefficient: 1 }, { formula: 'SO2', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: 'Zn + 2H₂SO₄ → ZnSO₄ + SO₂ + 2H₂O' },
    { id: 55, level: 4, reactants: [{ formula: 'Cu', coefficient: 3 }, { formula: 'HNO3', coefficient: 8 }], products: [{ formula: 'Cu(NO3)2', coefficient: 3 }, { formula: 'NO', coefficient: 2 }, { formula: 'H2O', coefficient: 4 }], equation: '3Cu + 8HNO₃ → 3Cu(NO₃)₂ + 2NO + 4H₂O' },
    { id: 56, level: 4, reactants: [{ formula: 'Cu', coefficient: 1 }, { formula: 'HNO3', coefficient: 4 }], products: [{ formula: 'Cu(NO3)2', coefficient: 1 }, { formula: 'NO2', coefficient: 2 }, { formula: 'H2O', coefficient: 2 }], equation: 'Cu + 4HNO₃ → Cu(NO₃)₂ + 2NO₂ + 2H₂O' },
    { id: 57, level: 4, reactants: [{ formula: 'Al', coefficient: 2 }, { formula: 'Fe2O3', coefficient: 1 }], products: [{ formula: 'Al2O3', coefficient: 1 }, { formula: 'Fe', coefficient: 2 }], equation: '2Al + Fe₂O₃ → Al₂O₃ + 2Fe' },
    { id: 58, level: 4, reactants: [{ formula: 'NH3', coefficient: 4 }, { formula: 'O2', coefficient: 5 }], products: [{ formula: 'NO', coefficient: 4 }, { formula: 'H2O', coefficient: 6 }], equation: '4NH₃ + 5O₂ → 4NO + 6H₂O' },
    { id: 59, level: 4, reactants: [{ formula: 'H2S', coefficient: 2 }, { formula: 'O2', coefficient: 3 }], products: [{ formula: 'SO2', coefficient: 2 }, { formula: 'H2O', coefficient: 2 }], equation: '2H₂S + 3O₂ → 2SO₂ + 2H₂O' },
    { id: 60, level: 4, reactants: [{ formula: 'Cl2', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], products: [{ formula: 'HCl', coefficient: 1 }, { formula: 'HClO', coefficient: 1 }], equation: 'Cl₂ + H₂O → HCl + HClO' },
    { id: 61, level: 4, reactants: [{ formula: 'P4', coefficient: 1 }, { formula: 'O2', coefficient: 5 }], products: [{ formula: 'P4O10', coefficient: 1 }], equation: 'P₄ + 5O₂ → P₄O₁₀' },
    { id: 62, level: 4, reactants: [{ formula: 'C', coefficient: 1 }, { formula: 'O2', coefficient: 1 }], products: [{ formula: 'CO2', coefficient: 1 }], equation: 'C + O₂ → CO₂' },
    { id: 63, level: 4, reactants: [{ formula: 'S', coefficient: 1 }, { formula: 'O2', coefficient: 1 }], products: [{ formula: 'SO2', coefficient: 1 }], equation: 'S + O₂ → SO₂' },
    { id: 64, level: 4, reactants: [{ formula: 'Ag', coefficient: 1 }, { formula: 'HNO3', coefficient: 2 }], products: [{ formula: 'AgNO3', coefficient: 1 }, { formula: 'NO2', coefficient: 1 }, { formula: 'H2O', coefficient: 1 }], equation: 'Ag + 2HNO₃ → AgNO₃ + NO₂ + H₂O' },
    { id: 65, level: 4, reactants: [{ formula: 'Ag', coefficient: 3 }, { formula: 'HNO3', coefficient: 4 }], products: [{ formula: 'AgNO3', coefficient: 3 }, { formula: 'NO', coefficient: 1 }, { formula: 'H2O', coefficient: 2 }], equation: '3Ag + 4HNO₃ → 3AgNO₃ + NO + 2H₂O' }
  ];
